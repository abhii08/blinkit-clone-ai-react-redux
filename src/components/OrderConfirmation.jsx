              ...
              {deliveryLoading.fetch ? (
                ...
                <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Waiting for Agent Assignment</p>
                      <p className="text-sm text-gray-600">Your order is confirmed and available for delivery agents to accept. An agent will be assigned shortly.</p>
                    </div>
                  </div>
                </div>
              )}
